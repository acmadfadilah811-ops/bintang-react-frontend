...
export const PENJUALAN_REPORTS = [
  ...
  {
    id: 'food-delivery',
    label: 'Rincian Penjualan Food delivery',
    toolbar: {
      paket: 'select',
      cari: false,
      selectOptions: ['Telah Bayar', '+Belum Bayar'],
    ...
    columns: [
      ...
      { key: 'pelanggan', label: 'Pelanggan' },
      { key: 'total_penjualan', label: 'Total Penjualan', align: 'right' },
      { key: 'subtotal_net', label: 'Subtotal net', align: 'right' },
      { key: 'food_delivery_fee', label: 'Food delivery fee', align: 'right' },
      { key: 'pengiriman_pajak', label: 'Pengiriman+Pajak', align: 'right' },
      { key: 'total_amount_net', label: 'Total amount net', align: 'right' },
      { key: 'diskon', label: 'Diskon', align: 'right' },
    ],
  },
  {
  ...
  },
  {
    ...
    toolbar: {
      paket: 'select',
      cari: false,
      selectOptions: ['Pembayaran', 'penjualan'],
      selectDefault: 'Pembayaran',
    },
    labaRugi: [
      {
        code: 'A',
      ...
      { code: 'G', title: 'Food Delivery', total: 'IDR 0', empty: true, items: [] },
